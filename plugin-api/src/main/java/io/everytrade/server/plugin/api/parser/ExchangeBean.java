...
//        return transactionPrice.divide(baseQuantity, Configuration.DECIMAL_DIGITS, RoundingMode.HALF_UP);
        return transactionPrice.divide(baseQuantity, 10, RoundingMode.HALF_UP);
    }
