...
public enum Currency {
    ...
    AE(false, Instant.parse("2017-06-01T00:00:00"), "Aeternity"),
    APPC(false, Instant.parse("2018-06-03T00:00:00"), "AppCoins"),
    ARN(false, Instant.parse("2017-11-01T00:00:00"), "Aeron"),
    AST(false, Instant.parse("2017-10-12T00:00:00"), "AirSwap"),
    BCD(false, Instant.parse("2017-11-22T00:00:00"), "Bitcoin Diamond"),
    BCN(false, Instant.parse("2014-06-09T00:00:00"), "Bytecoin"),
    CHAT(false, Instant.parse("2018-06-17T00:00:00"), "ChatCoin"),
    CLOAK(false, Instant.parse("2014-06-02T00:00:00"), "CloakCoin"),
    CMT(false, Instant.parse("2017-11-29T00:00:00"), "CyberMiles"),
    CND(false, Instant.parse("2017-10-12T00:00:00"), "Cindicator"),
    DGD(false, Instant.parse("2016-04-14T00:00:00"), "DigixDAO"),
    DLT(false, Instant.parse("2017-08-07T00:00:00"), "Agrello"),
    EDO(false, Instant.parse("2017-10-12T00:00:00"), "Eidoo"),
    FUEL(false, Instant.parse("2017-11-26T00:00:00"), "Etherparty"),
    GVT(false, Instant.parse("2017-11-08T00:00:00"), "Genesis Vision"),
    HC(false, Instant.parse("2017-08-17T00:00:00"), "HyperCash"),
    INS(false, Instant.parse("2022-03-30T00:00:00"), "iNFTspace"),
    LEND(false, Instant.parse("2017-11-29T00:00:00"), "Aave"),
    LUN(false, Instant.parse("2017-04-27T00:00:00"), "Lunyr"),
    MDA(false, Instant.parse("2017-09-07T00:00:00"), "Moeda Loyalty Points"),
    MTH(false, Instant.parse("2017-08-31T00:00:00"), "Monetha"),
    NAS(false, Instant.parse("2017-08-17T00:00:00"), "Nebulas"),
    NCASH(false, Instant.parse("2018-03-07T00:00:00"), "Nucleus Vision"),
    OAX(false, Instant.parse("2017-07-27T00:00:00"), "OAX"),
    OST(false, Instant.parse("2017-12-13T00:00:00"), "OST"),
    POE(false, Instant.parse("2017-08-31T00:00:00"), "Po.et"),
    QLC(false, Instant.parse("2018-01-03T00:00:00"), "QLC Chain"),
    RCN(false, Instant.parse("2017-10-26T00:00:00"), "Ripio Credit Network"),
    SNGLS(false, Instant.parse("2016-08-29T00:00:00"), "SingularDTV"),
    SNM(false, Instant.parse("2017-06-15T00:00:00"), "SONM"),
    SNT(false, Instant.parse("2017-06-22T00:00:00"), "Status"),
    STORM(false, Instant.parse("2022-02-06T00:00:00"), "StormToken"),
    SUB(false, Instant.parse("2017-08-21T00:00:00"), "Substratum"),
    TNT(false, Instant.parse("2017-08-24T00:00:00"), "Tierion"),
    VIB(false, Instant.parse("2017-10-05T00:00:00"), "Viberate"),
    VIBE(false, Instant.parse("2017-10-21T00:00:00"), "VIBE");
