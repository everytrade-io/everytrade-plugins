...
public enum Currency {
    ...
    AMP(false, Instant.parse("2015-19-03T00:00:00Z"), "Amp"),
    ...
    //    BAT	(false, Instant.parse("2017-06-01T00:00:00Z"),"Basic Attention Token"),
    ...
    //    DIA	(false, Instant.parse("2020-09-17T00:00:00Z"),"Dia"),
    ...
    //    EGLD	(false, Instant.parse("2020-09-17T00:00:00Z"),"Elrond"),
    ...
    //    FLOW	(false, Instant.parse("2018-05-01T00:00:00Z"),"Flow"),
    ...
    //    HOT	(false, Instant.parse("2018-04-26T00:00:00Z"),"Holo"),
//    ICP	(false, Instant.parse("2021-05-12T00:00:00Z"),"Internet Computer"),
//    ICX	(false, Instant.parse("2017-10-26T00:00:00Z"),"ICON"),
    ...
    //    ONE	(false, Instant.parse("2019-05-30T00:00:00Z"),"Harmony"),
    ...
    //    RLC	(false, Instant.parse("2017-01-10T00:00:00Z"),"iExec RLC"),
