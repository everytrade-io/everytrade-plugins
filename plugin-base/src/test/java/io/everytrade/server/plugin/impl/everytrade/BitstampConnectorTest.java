...
import io.everytrade.server.test.mock.BitstampExchangeMock;
...
class BitstampConnectorTest {
    ...
    void testBuySellDepositWithdrawal() {
        ...
        var connector = new BitstampConnector(new BitstampExchangeMock(trades, records));
