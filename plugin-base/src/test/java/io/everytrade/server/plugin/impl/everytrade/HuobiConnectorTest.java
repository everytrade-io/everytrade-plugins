...
class HuobiConnectorTest {
    ...
    void testBuySellDepositWithdrawal() {
        ...
        trades.add(userTrade(BUY, TEN, PAIR, new BigDecimal("10000"), TEN, USD, tradeDate, "1"));
        trades.add(userTrade(SELL, ONE, PAIR, new BigDecimal("20000"), TEN, USD, tradeDate, "2"));
