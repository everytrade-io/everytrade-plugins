...
//MIN> SHP-001:|Transaction Type|Date|Amount Debited|Debit Currency|Amount Credited|Credit Currency|
//FULL> SHP-001:|Transaction Type|Date|Amount Debited|Debit Currency|Amount Credited|Credit Currency|
...
public class ShakePayBeanV1 extends ExchangeBean {
    ...
    public ShakePayBeanV1() {
        super(SupportedExchange.SHAKEPAY);
    }
