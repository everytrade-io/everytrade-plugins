...
//MIN> PAX-001:|type|fiat_currency|amount_fiat|amount_btc|status|completed_at|trade_hash|
//FULL> PAX-001:|type|fiat_currency|amount_fiat|amount_btc|rate|fee_fiat|fee_btc|market_rate_usd|
...
public class PaxfulBeanV1 extends ExchangeBean {
    ...
    public PaxfulBeanV1() {
        super(SupportedExchange.PAXFUL);
    }
