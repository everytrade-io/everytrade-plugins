...
import io.everytrade.server.plugin.api.parser.DateTimeConverterWithSecondsFraction;
...
//MIN> KRK-001:|txid|pair|time|type|cost|fee|vol|
//FULL> KRK-001:|txid|ordertxid|pair|time|type|ordertype|price|cost|fee|vol|margin|misc|ledgers|
...
public class KrakenBeanV1 extends ExchangeBean {
    ...
    public KrakenBeanV1() {
        super(SupportedExchange.KRAKEN);
    }
