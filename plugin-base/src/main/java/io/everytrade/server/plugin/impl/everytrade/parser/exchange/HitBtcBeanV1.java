...
//MIN> HTB-001:|^Date \(.*\)$|Instrument|Trade ID|Side|Quantity|Price|Fee|Rebate|
//FULL> HTB-001:|^Date \(.*\)$|Instrument|Trade ID|Order ID|Side|Quantity|Price|Volume|Fee|Rebate|Total|
...
public class HitBtcBeanV1 extends ExchangeBean {
    ...
    public HitBtcBeanV1() {
        super(SupportedExchange.HITBTC);
    }
