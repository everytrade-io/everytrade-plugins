...
public enum BinanceOperationTypeV4 {
    ...
    OPERATION_TYPE_BNB_FEE_DEDUCTION("BNB FEE DEDUCTION", false),
    OPERATION_TYPE_DEPOSIT_FIAT_OCBS("DEPOSIT FIAT OCBS", false),
    OPERATION_TYPE_CONVERT_FIAT_TO_CRYPTO_OCBS("CONVERT FIAT TO CRYPTO OCBS", true),
    OPERATION_TYPE_AIRDROP_ASSETS("AIRDROP ASSETS", false),
    OPERATION_TYPE_ETH2_0_STAKING("ETH 2.0 STAKING", true),
    OPERATION_TYPE_ETH2_0_STAKING_REWARDS("ETH 2.0 STAKING REWARDS",false),
    ...
    OPERATION_TYPE_BUY_CRYPTO_WITH_FIAT("BUY CRYPTO WITH FIAT", true),
    OPERATION_TYPE_SELL_CRYPTO_TO_FIAT("SELL CRYPTO TO FIAT", true),
    ...
    OPERATION_TYPE_SIMPLE_EARN_LOCKED_SUBSCRIPTION("SIMPLE EARN LOCKED SUBSCRIPTION", false),
    ...
    OPERATION_TYPE_TOKEN_SWAP("TOKEN SWAP - DISTRIBUTION", false),
    OPERATION_TYPE_TRANSFER_BETWEEN_MAIN_ACC_AND_SUB_ACC("TRANSFER BETWEEN MAIN ACCOUNT AND SUB-ACCOUNT", false),

    // UNSUPPORTED OPERATIONS
    OPERATION_TYPE_TRANSFER_BETWEEN_MAIN_AND_FUNDING_WALLET("TRANSFER BETWEEN MAIN AND FUNDING WALLET", true),
