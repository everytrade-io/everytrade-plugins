...
//MIN> LOB-001:|id|trade_type|btc_final|fiat_amount|currency|transaction_released_at|
//FULL> LOB-001:|id|created_at|buyer|seller|trade_type|btc_amount|btc_traded|fee_btc|btc_amount_less_fee|btc_final|
...
public class LocalBitcoinsBeanV1 extends ExchangeBean {
    ...
    public LocalBitcoinsBeanV1() {
        super(SupportedExchange.LOCALBITCOINS);
    }
    ...
    public void setTradeType(String value) {
        if ("ONLINE_BUY".equals(value)) {
            ...
            throw new DataValidationException(UNKNOWN_TRANSACTION_TYPE.concat(value));
        }
    }
