...
public class BinanceSupportedOperations {
    ...
    static {
        ...
        SUPPORTED_OPERATION_TYPES.add(BinanceOperationTypeV4.OPERATION_TYPE_BUY_CRYPTO_WITH_FIAT.code);
        SUPPORTED_OPERATION_TYPES.add(BinanceOperationTypeV4.OPERATION_TYPE_SELL_CRYPTO_TO_FIAT.code);
        ...
        SUPPORTED_OPERATION_TYPES.add(BinanceOperationTypeV4.OPERATION_TYPE_SIMPLE_EARN_LOCKED_SUBSCRIPTION.code);
        ...
        SUPPORTED_OPERATION_TYPES.add(BinanceOperationTypeV4.OPERATION_TYPE_BNB_FEE_DEDUCTION.code);
        SUPPORTED_OPERATION_TYPES.add(BinanceOperationTypeV4.OPERATION_TYPE_TOKEN_SWAP.code);
        SUPPORTED_OPERATION_TYPES.add(BinanceOperationTypeV4.OPERATION_TYPE_TRANSFER_BETWEEN_MAIN_ACC_AND_SUB_ACC.code);
