...
//MIN> BMX-001:|transactTime|symbol|execType|side|lastQty|lastPx|execComm|orderID|
//FULL> BMX-001:|transactTime|symbol|execType|side|lastQty|lastPx|execCost|commission|execComm|ordType|orderQty
// |leavesQty|price|text|orderID|
...
public class BitmexBeanV1 extends ExchangeBean {
    ...
    public BitmexBeanV1() {
        super(SupportedExchange.BITMEX);
    }
